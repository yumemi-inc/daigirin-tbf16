...
個人的にはあくまでサンノゼに限った話ですが、公共交通機関を利用してもいいのかなと感じています。サンノゼ含む、サンフランシスコベイエリアでは交通系ICカードの ClipperCard があるので作成しておくと便利です。
Walletアプリでバーチャルカードを取得することもできますが、物理カードも簡単に取得できますが、残念ながら空港では入手できないので手順を紹介します。

1. サンノゼ空港到着口を出て正面の小島のようなエリアから60系統(北方面)のバスが出ているので乗りましょう。
