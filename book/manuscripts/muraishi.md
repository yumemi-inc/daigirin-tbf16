...
2. バス停で降りて正面に Milpitas 駅がありますので、駅構内の左の壁沿いに　Clipper Card を発行できる自動販売機があるのでそちらで発券しましょう。デポジット $3 + デフォルトで $20 になっていますが、入金額は増減できます。乗り放題パスなどもありますが、1日あたり $10 分も入れておけば困ることはないと思います。($2.5 の先払い制で、1回払えば2時間ライトレール・バスが乗り放題になるので十分)
